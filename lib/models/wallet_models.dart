...
/// 회사 지갑
/// 
/// 주의: companyName, userRole, status는 wallets 테이블에 없습니다.
/// companies 테이블과 company_users 테이블을 JOIN하여 가져와야 합니다.
class CompanyWallet {
  final String id;
  final String companyId;
  final String companyName; // companies 테이블에서 JOIN 필요
  final int currentPoints;
  final String userRole; // company_users 테이블에서 JOIN 필요
  final String status; // company_users 테이블에서 JOIN 필요
  final String? withdrawBankName;
  final String? withdrawAccountNumber;
  final String? withdrawAccountHolder;
