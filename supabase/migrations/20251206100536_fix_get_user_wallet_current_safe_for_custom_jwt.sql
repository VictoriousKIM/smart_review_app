...
-- ============================================
-- get_user_campaign_logs_safe 함수 수정 (함수 오버로딩 충돌 해결)
-- ============================================

-- 기존 함수 완전히 삭제 (모든 오버로딩 버전)
DROP FUNCTION IF EXISTS "public"."get_user_campaign_logs_safe"("p_user_id" "uuid", "p_status" "text", "p_limit" integer, "p_offset" integer);
DROP FUNCTION IF EXISTS "public"."get_user_campaign_logs_safe"("p_user_id" "uuid", "p_status" "text", "p_limit" integer);
