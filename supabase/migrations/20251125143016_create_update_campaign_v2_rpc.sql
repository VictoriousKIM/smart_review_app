...
ALTER FUNCTION "public"."apply_to_campaign_safe"("p_campaign_id" "uuid", "p_application_message" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."cancel_application_safe"("p_application_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."create_review_safe"("p_campaign_id" "uuid", "p_title" "text", "p_content" "text", "p_rating" integer, "p_review_url" "text") OWNER TO "postgres";
...
BEGIN
  ...
  IF v_refund_amount > 0 THEN
    ...
    INSERT INTO public.point_transactions (
      ...
      '캠페인 삭제 환불: ' || COALESCE(v_campaign_title, ''),
      v_user_id,
      NOW()
    );
  END IF;
...
ALTER FUNCTION "public"."delete_review_safe"("p_review_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_campaign_applications_safe"("p_campaign_id" "uuid", "p_status" "text", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_company_wallets_safe"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_user_applications_safe"("p_status" "text", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_user_company_id_safe"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_user_company_role_safe"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_user_point_history_safe"("p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_user_reviews_safe"("p_status" "text", "p_limit" integer, "p_offset" integer) OWNER TO "postgres";
...
ALTER FUNCTION "public"."get_user_wallet_current_safe"() OWNER TO "postgres";
...
ALTER FUNCTION "public"."update_application_status_safe"("p_application_id" "uuid", "p_status" "text", "p_rejection_reason" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."update_review_safe"("p_review_id" "uuid", "p_title" "text", "p_content" "text", "p_rating" integer, "p_review_url" "text") OWNER TO "postgres";
...
ALTER FUNCTION "public"."update_review_status_safe"("p_review_id" "uuid", "p_status" "text", "p_rejection_reason" "text") OWNER TO "postgres";
