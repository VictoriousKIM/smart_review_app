...
BEGIN
  IF p_payment_method = 'platform' THEN
    -- 플랫폼 지급: (결제금액 + 캠페인 리워드 + 0) * 인원 (베타 기간 무료)
    RETURN (p_payment_amount + p_campaign_reward + 0) * p_max_participants;
  ELSE
    -- 직접 지급: 0 * 인원 (베타 기간 무료)
    RETURN 0 * p_max_participants;
  END IF;
END;
$$;
...
BEGIN
  ...
  INSERT INTO public.campaigns (
    ...
    p_end_date + INTERVAL '1 day', p_end_date + INTERVAL '31 days',
    'active', NOW(), NOW()
...
CREATE OR REPLACE FUNCTION "public"."create_campaign_with_points_v2"("p_title" "text", "p_description" "text", "p_campaign_type" "text", "p_campaign_reward" integer, "p_max_participants" integer, "p_apply_start_date" timestamp with time zone, "p_apply_end_date" timestamp with time zone, "p_platform" "text" DEFAULT NULL::"text", "p_keyword" "text" DEFAULT NULL::"text", "p_option" "text" DEFAULT NULL::"text", "p_quantity" integer DEFAULT 1, "p_seller" "text" DEFAULT NULL::"text", "p_product_number" "text" DEFAULT NULL::"text", "p_product_image_url" "text" DEFAULT NULL::"text", "p_product_name" "text" DEFAULT NULL::"text", "p_product_price" integer DEFAULT NULL::integer, "p_purchase_method" "text" DEFAULT 'mobile'::"text", "p_product_provision_type" "text" DEFAULT NULL::"text", "p_product_description" "text" DEFAULT NULL::"text", "p_review_type" "text" DEFAULT 'star_only'::"text", "p_review_text_length" integer DEFAULT NULL::integer, "p_review_image_count" integer DEFAULT NULL::integer, "p_prevent_product_duplicate" boolean DEFAULT false, "p_prevent_store_duplicate" boolean DEFAULT false, "p_duplicate_prevent_days" integer DEFAULT 0, "p_payment_method" "text" DEFAULT NULL::"text", "p_review_start_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_review_end_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_max_per_reviewer" integer DEFAULT 1, "p_user_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
DECLARE
...
BEGIN
    ...
    FROM public.wallets
    WHERE company_id = v_company_id AND wallet_type = 'company'
    LIMIT 1;
    ...
    v_points_required := (p_campaign_reward * p_max_participants);
    ...
    IF v_current_balance < v_points_required THEN
        RAISE EXCEPTION '포인트가 부족합니다 (필요: %, 현재: %)', v_points_required, v_current_balance;
    END IF;

    -- Deduct points
    UPDATE public.wallets
    SET balance = balance - v_points_required,
        updated_at = NOW()
    WHERE id = v_company_wallet_id;

    -- Create campaign
    INSERT INTO public.campaigns (
        title, description, campaign_type, campaign_reward, max_participants,
        apply_start_date, apply_end_date, review_start_date, review_end_date,
        platform, keyword, option, quantity, seller, product_number,
        product_image_url, product_name, product_price, purchase_method,
        product_provision_type, product_description, review_type,
        review_text_length, review_image_count, prevent_product_duplicate,
        prevent_store_duplicate, duplicate_prevent_days, payment_method,
        max_per_reviewer, user_id, company_id, status, created_at, updated_at
    ) VALUES (
        p_title, p_description, p_campaign_type, p_campaign_reward, p_max_participants,
        p_apply_start_date, p_apply_end_date, p_review_start_date, p_review_end_date,
        p_platform, p_keyword, p_option, p_quantity, p_seller, p_product_number,
        p_product_image_url, p_product_name, p_product_price, p_purchase_method,
        p_product_provision_type, p_product_description, p_review_type,
        p_review_text_length, p_review_image_count, p_prevent_product_duplicate,
        p_prevent_store_duplicate, p_duplicate_prevent_days, p_payment_method,
        p_max_per_reviewer, v_user_id, v_company_id, 'active', NOW(), NOW()
    ) RETURNING id INTO v_campaign_id;
...
ALTER FUNCTION "public"."get_user_company_id_all_roles_safe"("p_user_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."remove_manager_safe"("p_company_id" "uuid", "p_manager_user_id" "uuid", "p_current_user_id" "uuid") OWNER TO "postgres";
...
ALTER FUNCTION "public"."search_companies_by_name"("p_business_name" "text", "p_user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_campaign_v2"("p_campaign_id" "uuid", "p_title" "text", "p_description" "text", "p_campaign_type" "text", "p_campaign_reward" integer, "p_max_participants" integer, "p_max_per_reviewer" integer, "p_apply_start_date" timestamp with time zone, "p_apply_end_date" timestamp with time zone, "p_platform" "text" DEFAULT NULL::"text", "p_keyword" "text" DEFAULT NULL::"text", "p_option" "text" DEFAULT NULL::"text", "p_quantity" integer DEFAULT 1, "p_seller" "text" DEFAULT NULL::"text", "p_product_number" "text" DEFAULT NULL::"text", "p_product_image_url" "text" DEFAULT NULL::"text", "p_product_name" "text" DEFAULT NULL::"text", "p_product_price" integer DEFAULT NULL::integer, "p_purchase_method" "text" DEFAULT 'mobile'::"text", "p_product_provision_type" "text" DEFAULT NULL::"text", "p_review_type" "text" DEFAULT 'star_only'::"text", "p_review_text_length" integer DEFAULT NULL::integer, "p_review_image_count" integer DEFAULT NULL::integer, "p_prevent_product_duplicate" boolean DEFAULT false, "p_prevent_store_duplicate" boolean DEFAULT false, "p_duplicate_prevent_days" integer DEFAULT 0, "p_payment_method" "text" DEFAULT NULL::"text", "p_review_start_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_review_end_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_user_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
DECLARE
...
COMMENT ON FUNCTION "public"."update_campaign_v2"("p_campaign_id" "uuid", "p_title" "text", "p_description" "text", "p_campaign_type" "text", "p_campaign_reward" integer, "p_max_participants" integer, "p_max_per_reviewer" integer, "p_apply_start_date" timestamp with time zone, "p_apply_end_date" timestamp with time zone, "p_platform" "text", "p_keyword" "text", "p_option" "text", "p_quantity" integer, "p_seller" "text", "p_product_number" "text", "p_product_image_url" "text", "p_product_name" "text", "p_product_price" integer, "p_purchase_method" "text", "p_product_provision_type" "text", "p_review_type" "text", "p_review_text_length" integer, "p_review_image_count" integer, "p_prevent_product_duplicate" boolean, "p_prevent_store_duplicate" boolean, "p_duplicate_prevent_days" integer, "p_payment_method" "text", "p_review_start_date" timestamp with time zone, "p_review_end_date" timestamp with time zone, "p_user_id" "uuid") IS '캠페인 업데이트 (review_keywords 제거됨)';



CREATE OR REPLACE FUNCTION "public"."update_campaign_v2"("p_campaign_id" "uuid", "p_title" "text", "p_description" "text", "p_campaign_type" "text", "p_campaign_reward" integer, "p_max_participants" integer, "p_max_per_reviewer" integer, "p_apply_start_date" timestamp with time zone, "p_apply_end_date" timestamp with time zone, "p_platform" "text" DEFAULT NULL::"text", "p_keyword" "text" DEFAULT NULL::"text", "p_option" "text" DEFAULT NULL::"text", "p_quantity" integer DEFAULT 1, "p_seller" "text" DEFAULT NULL::"text", "p_product_number" "text" DEFAULT NULL::"text", "p_product_image_url" "text" DEFAULT NULL::"text", "p_product_name" "text" DEFAULT NULL::"text", "p_product_price" integer DEFAULT NULL::integer, "p_purchase_method" "text" DEFAULT 'mobile'::"text", "p_product_provision_type" "text" DEFAULT NULL::"text", "p_review_type" "text" DEFAULT 'star_only'::"text", "p_review_text_length" integer DEFAULT NULL::integer, "p_review_image_count" integer DEFAULT NULL::integer, "p_prevent_product_duplicate" boolean DEFAULT false, "p_prevent_store_duplicate" boolean DEFAULT false, "p_duplicate_prevent_days" integer DEFAULT 0, "p_payment_method" "text" DEFAULT NULL::"text", "p_review_start_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_review_end_date" timestamp with time zone DEFAULT NULL::timestamp with time zone, "p_review_keywords" "text"[] DEFAULT NULL::"text"[], "p_user_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
DECLARE
...
COMMENT ON FUNCTION "public"."update_campaign_v2"("p_campaign_id" "uuid", "p_title" "text", "p_description" "text", "p_campaign_type" "text", "p_campaign_reward" integer, "p_max_participants" integer, "p_max_per_reviewer" integer, "p_apply_start_date" timestamp with time zone, "p_apply_end_date" timestamp with time zone, "p_platform" "text", "p_keyword" "text", "p_option" "text", "p_quantity" integer, "p_seller" "text", "p_product_number" "text", "p_product_image_url" "text", "p_product_name" "text", "p_product_price" integer, "p_purchase_method" "text", "p_product_provision_type" "text", "p_review_type" "text", "p_review_text_length" integer, "p_review_image_count" integer, "p_prevent_product_duplicate" boolean, "p_prevent_store_duplicate" boolean, "p_duplicate_prevent_days" integer, "p_payment_method" "text", "p_review_start_date" timestamp with time zone, "p_review_end_date" timestamp with time zone, "p_review_keywords" "text"[], "p_user_id" "uuid") IS '캠페인 업데이트 (review_keywords 지원)';
...
CREATE INDEX "idx_campaigns_review_keywords" ON "public"."campaigns" USING "gin" ("review_keywords");
...
CREATE POLICY "Companies are viewable by owners and managers" ON "public"."companies" FOR SELECT USING (((EXISTS ( SELECT 1
   FROM "public"."company_users" "cu"
  WHERE (("cu"."company_id" = "companies"."id") AND ("cu"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cu"."company_role" = ANY (ARRAY['owner'::"text", 'manager'::"text"])) AND ("cu"."status" = 'active'::"text")))) OR ("user_id" = ( SELECT "auth"."uid"() AS "uid"))));
...
CREATE POLICY "Company members can view company wallet" ON "public"."wallets" FOR SELECT USING ((("company_id" IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM "public"."company_users" "cu"
  WHERE (("cu"."company_id" = "wallets"."company_id") AND ("cu"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cu"."status" = 'active'::"text"))))));
...
CREATE POLICY "Company owners can update company wallet account" ON "public"."wallets" FOR UPDATE USING ((("company_id" IS NOT NULL) AND (EXISTS ( SELECT 1
  ...
  WHERE (("cu"."company_id" = "wallets"."company_id") AND ("cu"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cu"."company_role" = 'owner'::"text") AND ("cu"."status" = 'active'::"text")))))) WITH CHECK ((("company_id" IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM "public"."company_users" "cu"
  WHERE (("cu"."company_id" = "wallets"."company_id") AND ("cu"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cu"."company_role" = 'owner'::"text") AND ("cu"."status" = 'active'::"text"))))));
...
CREATE POLICY "Users can create their own SNS connections" ON "public"."sns_connections" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "Users can create their own cash transactions" ON "public"."cash_transactions" FOR INSERT WITH CHECK (("wallet_id" IN ( SELECT "wallets"."id"
   FROM "public"."wallets"
  WHERE ("wallets"."user_id" = ( SELECT "auth"."uid"() AS "uid")))));



CREATE POLICY "Users can delete their own SNS connections" ON "public"."sns_connections" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "Users can insert their own wallet histories" ON "public"."wallet_logs" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."wallets" "w"
  WHERE (("w"."id" = "wallet_logs"."wallet_id") AND (("w"."user_id" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
           FROM "public"."company_users" "cu"
          WHERE (("cu"."company_id" = "w"."company_id") AND ("cu"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cu"."status" = 'active'::"text") AND ("cu"."company_role" = 'owner'::"text")))))))));
...
CREATE POLICY "Users can update their own SNS connections" ON "public"."sns_connections" FOR UPDATE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Users can update their own wallet account" ON "public"."wallets" FOR UPDATE USING (("user_id" = ( SELECT "auth"."uid"() AS "uid"))) WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "Users can view logs of their cash transactions" ON "public"."cash_transaction_logs" FOR SELECT USING (("transaction_id" IN ( SELECT "pt"."id"
   FROM ("public"."cash_transactions" "pt"
     JOIN "public"."wallets" "w" ON (("w"."id" = "pt"."wallet_id")))
  WHERE ("w"."user_id" = ( SELECT "auth"."uid"() AS "uid")))));



CREATE POLICY "Users can view their own SNS connections" ON "public"."sns_connections" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "Users can view their own wallet" ON "public"."wallets" FOR SELECT USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "Users can view their own wallet histories" ON "public"."wallet_logs" FOR SELECT USING ((EXISTS ( SELECT 1
  ...
  WHERE (("w"."id" = "wallet_logs"."wallet_id") AND (("w"."user_id" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
           FROM "public"."company_users" "cu"
          WHERE (("cu"."company_id" = "w"."company_id") AND ("cu"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cu"."status" = 'active'::"text")))))))));
...
CREATE POLICY "Users can view transfers involving their wallets" ON "public"."point_transfers" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."wallets" "w"
  WHERE ((("w"."id" = "point_transfers"."from_wallet_id") OR ("w"."id" = "point_transfers"."to_wallet_id")) AND (("w"."user_id" = ( SELECT "auth"."uid"() AS "uid")) OR (("w"."company_id" IS NOT NULL) AND (EXISTS ( SELECT 1
           FROM "public"."company_users" "cu"
          WHERE (("cu"."company_id" = "w"."company_id") AND ("cu"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("cu"."status" = 'active'::"text"))))))))));
...
GRANT ALL ON FUNCTION "public"."get_user_company_id_all_roles_safe"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_user_company_id_all_roles_safe"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_company_id_all_roles_safe"("p_user_id" "uuid") TO "service_role";
